...
/*********************************************************************************************/
/* Funcion que devuelve la carta que echa la IA de idas					     */
...
void Idas(struct tpEstadoIA *EstadoIA, struct tpcarta *Carta)
{
 bool yaesta;
 ...
 yaesta = 0;
 if (EstadoIA->turno == 1){
   /*Si es la última ronda y el triunfo del corro es bueno, intentará salir de bresca*/
   if ((*EstadoIA->num_ronda == 4) && (EstadoIA->dificil == 1) && (
        (EstadoIA->Triunfo->valor >= '8') ||
        ((EstadoIA->PaloT.Datos->sota == '1') && (EstadoIA->Triunfo->valor == '7')) ||
        ((EstadoIA->PaloT.Datos->rey == '1') && (EstadoIA->Triunfo->valor == '6')))){
     if (EstadoIA->Palo1.N > 0){
       if ((EstadoIA->Palo1.Datos->as == '1') || ((EstadoIA->Palo1.Datos->tres == '1') && (EstadoIA->Palo1.Datos->as == '2'))){
         *Carta = EstadoIA->Palo1.Palo[EstadoIA->Palo1.N-1]; yaesta = 1;
       }
     }
     if ((EstadoIA->Palo2.N > 0) && (yaesta == 0)){
       if ((EstadoIA->Palo2.Datos->as == '1') || ((EstadoIA->Palo2.Datos->tres == '1') && (EstadoIA->Palo2.Datos->as == '2'))){
         *Carta = EstadoIA->Palo2.Palo[EstadoIA->Palo2.N-1]; yaesta = 1;
       }
     }
     if ((EstadoIA->Palo3.N > 0) && (yaesta == 0)){
       if ((EstadoIA->Palo3.Datos->as == '1') || ((EstadoIA->Palo3.Datos->tres == '1') && (EstadoIA->Palo3.Datos->as == '2'))){
 ...
 if (EstadoIA->turno == 2){
   /*Casos particulares para la ronda 4*/
   if ((*EstadoIA->num_ronda == 4) && (EstadoIA->dificil == 1)){
     /*Si el corro es una sota o un rey y tiene la pareja intenta quedársela*/
     if ((EstadoIA->Mesa.jugador1.palo != EstadoIA->Triunfo->palo) &&
         (EstadoIA->Mesa.jugador1.valor < '8') && /*carta1 no es triunfo ni bresca*/
         ((EstadoIA->PaloT.Datos->sota == '1') && (EstadoIA->Triunfo->valor == '7')) ||
         ((EstadoIA->PaloT.Datos->rey == '1') && (EstadoIA->Triunfo->valor == '6'))){
       if (EstadoIA->Palo1.N > 0){/*Intentamos montar con bresca*/
         if ((EstadoIA->Palo1.Palo[0].palo == EstadoIA->Mesa.jugador1.palo) &&
             (EstadoIA->Palo1.Datos->as == '1') || ((EstadoIA->Palo1.Datos->tres == '1') && (EstadoIA->Palo1.Datos->as == '2'))){
           *Carta = EstadoIA->Palo1.Palo[EstadoIA->Palo1.N-1]; yaesta = 1;
         }
       }
       if ((EstadoIA->Palo2.N > 0) && (yaesta == 0)){
         if ((EstadoIA->Palo2.Palo[0].palo == EstadoIA->Mesa.jugador1.palo) &&
             (EstadoIA->Palo2.Datos->as == '1') || ((EstadoIA->Palo2.Datos->tres == '1') && (EstadoIA->Palo2.Datos->as == '2'))){
           *Carta = EstadoIA->Palo2.Palo[EstadoIA->Palo2.N-1]; yaesta = 1;
         }
       }
       if ((EstadoIA->Palo3.N > 0) && (yaesta == 0)){
         if ((EstadoIA->Palo3.Palo[0].palo == EstadoIA->Mesa.jugador1.palo) &&
             (EstadoIA->Palo3.Datos->as == '1') || ((EstadoIA->Palo3.Datos->tres == '1') && (EstadoIA->Palo3.Datos->as == '2'))){
           *Carta = EstadoIA->Palo3.Palo[EstadoIA->Palo3.N-1]; yaesta = 1;
         }
       }
       if (yaesta == 0){
   ...
   /*Comprobamos si carta1 es triunfo*/
   if ((EstadoIA->Mesa.jugador1.palo == EstadoIA->Triunfo->palo) && (yaesta == 0)){
     Descarte(EstadoIA,Carta); yaesta = 1;
   }
   /*Intentamos montar carta1*/
   if (yaesta == 0) {
     yaesta = puedoMontar(EstadoIA,Carta,&EstadoIA->Mesa.jugador1,'7');
   }
   /*Si carta1 es una bresca, intentamos montarla con triunfo pequeño, si no nos descartamos*/
   if ((EstadoIA->Mesa.jugador1.valor >= '8') && (yaesta == 0)
       && (EstadoIA->PaloT.Datos->medianas >= 1) && (EstadoIA->PaloT.N > 1)){
      if (EstadoIA->PaloT.Palo[0].valor != '4'){
         *Carta = EstadoIA->PaloT.Palo[0]; yaesta = 1;
      }
      else if ((EstadoIA->PaloT.Palo[1].valor == '5') && (EstadoIA->PaloT.N > 2)){
        *Carta = EstadoIA->PaloT.Palo[1]; yaesta = 1;
      }
   }
   if (yaesta == 0){
     Descarte(EstadoIA,Carta); yaesta = 1;
 ...
 if (EstadoIA->turno == 3){
   ...
   if ((*EstadoIA->num_ronda == 4) && (EstadoIA->dificil == 1)){
     if ((EstadoIA->Triunfo->valor >= '6') && (EstadoIA->Mesa.jugador2.valor >= '8') && (EstadoIA->Mesa.jugador2.palo != EstadoIA->Triunfo->palo)){
       /*Es posible que el segundo jugador haya echado la bresca para poder quedarse con el triunfo
        ...
        intentar que la IA mate, cosa que no sucederá*/
        CartaAux.palo = EstadoIA->Triunfo->palo; CartaAux.valor = '4';
        if ((tieneCarta(EstadoIA,CartaAux)) || /*tiene el siete de triunfo, hay que matar*/
            ((EstadoIA->PaloT.Datos->sota == '1') && (EstadoIA->Triunfo->valor == '7')) ||
            ((EstadoIA->PaloT.Datos->rey == '1') && (EstadoIA->Triunfo->valor == '6')) ||
            /*la carta del corro es una sota o un rey, pero la IA tiene la pareja así que
             sabe que el oponente no podra cantar las 40 y mata la bresca*/
            (EstadoIA->Triunfo->valor <= '5')){/*el corro tiene un valor relativo bajo, se mata la bresca*/
          /*Intentamos matar con un triunfo pequeño*/
          if ((EstadoIA->PaloT.Datos->medianas >= 1) && (EstadoIA->PaloT.N > 1)){
            if (EstadoIA->PaloT.Palo[0].valor != '4'){
   ...
   if ((yaesta == 0) && (vaNuestra(EstadoIA) || (EstadoIA->Mesa.jugador2.palo == EstadoIA->Triunfo->palo))){
     Descarte(EstadoIA,Carta); yaesta = 1;
   }
   /*Intentamos montar*/
   if (yaesta == 0){
   ...
   /*Intentamos matar con triunfo pequeño*/
   if ((yaesta == 0) && (EstadoIA->PaloT.N > 1) && (EstadoIA->PaloT.Datos->medianas >= 1) && (EstadoIA->puntosMesa >= 10)){
     if (EstadoIA->PaloT.Palo[0].valor != '4'){
        *Carta = EstadoIA->PaloT.Palo[0]; yaesta = 1;
     }
     else if ((EstadoIA->PaloT.Palo[1].valor == '5') && (EstadoIA->PaloT.N > 2)){
 ...
 if (EstadoIA->turno == 4){
   ...
   if ((EstadoIA->dificil == 1) && (vaNuestra(EstadoIA) == 0) && (EstadoIA->Triunfo->valor >= '6')
        && (EstadoIA->puntosMesa < 15) && (*EstadoIA->num_ronda == 4)){
     Descarte(EstadoIA,Carta); yaesta = 1;
   } /*fin de condiciones del turno 4*/
   /*Miramos a ver si va del compañero*/
   if ((yaesta == 0) && vaNuestra(EstadoIA)){ /*Va del compañero, intentamos echar bresca, si no descarte*/
     if (EstadoIA->Palo1.N > 0){
     ...
     if (EstadoIA->Palo2.N > 0){
       if ((yaesta == 0) && (EstadoIA->Palo2.Palo[EstadoIA->Palo2.N-1].valor >= '8')) {
         *Carta = EstadoIA->Palo2.Palo[EstadoIA->Palo2.N-1]; yaesta = 1;
       }
     }
     if (EstadoIA->Palo3.N > 0){
       if ((yaesta == 0) && (EstadoIA->Palo3.Palo[EstadoIA->Palo3.N-1].valor >= '8')) {
         *Carta = EstadoIA->Palo3.Palo[EstadoIA->Palo3.N-1]; yaesta = 1;
       }
     }
     if (yaesta == 0) {
   ...
   else if (yaesta == 0){ /*Va del otro equipo, intentamos montar o descartarnos según las cartas de la mesa*/
     /*Si carta1 es triunfo y carta3 no es bresca, se descarta*/
     if ((EstadoIA->Mesa.jugador1.palo == EstadoIA->Triunfo->palo) &&
         (EstadoIA->Mesa.jugador3.palo != EstadoIA->Triunfo->palo) &&
         (EstadoIA->Mesa.jugador3.valor < '8') && (yaesta == 0)){
       Descarte(EstadoIA,Carta); yaesta = 1;
     }
     ...
     if ((EstadoIA->Mesa.jugador1.palo == EstadoIA->Triunfo->palo) &&
         (EstadoIA->Mesa.jugador3.palo != EstadoIA->Triunfo->palo) &&
         (EstadoIA->Mesa.jugador3.valor >= '8') && (yaesta == 0)){
       if ((yaesta = puedoMontar(EstadoIA,Carta,&EstadoIA->Mesa.jugador1,'5')) == 0){
         Descarte(EstadoIA,Carta); yaesta = 1;
       }
     }
     /*carta1 no es triunfo, miramos a ver si carta3 es triunfo y hay puntos en la mesa*/
     if ((EstadoIA->dificil == 1) && (yaesta == 0) && ((EstadoIA->Mesa.jugador3.palo == EstadoIA->Triunfo->palo))
         && (EstadoIA->puntosMesa >= 11)){/*Buscamos matar la carta3*/
       if ((yaesta = puedoMontar(EstadoIA,Carta,&EstadoIA->Mesa.jugador3,'5')) == 0){
         Descarte(EstadoIA,Carta); yaesta = 1;
       }
     }
     ...
     CartaAux.palo = EstadoIA->Mesa.jugador1.palo; CartaAux.valor = '9';
     ...
     CartaAux.valor = '8';
     if ((yaesta == 0) && tieneCarta(EstadoIA,CartaAux)
         && (EstadoIA->Mesa.jugador1.valor != '9') && ((EstadoIA->Mesa.jugador3.palo != CartaAux.palo)
         || ((EstadoIA->Mesa.jugador3.palo == CartaAux.palo) && (EstadoIA->Mesa.jugador3.valor != '9')))){
       *Carta = CartaAux; yaesta = 1;
     }
     /*Guardamos en CartaAux la carta más alta entre carta1 y carta3*/
     CartaAux = cartaMayor(&EstadoIA->Mesa.jugador1,&EstadoIA->Mesa.jugador3,EstadoIA->Triunfo->palo) ? EstadoIA->Mesa.jugador1 : EstadoIA->Mesa.jugador3;
     /*Si hay 8 o mas puntos en la mesa, buscamos matar con algo que no sea triunfo*/
     if ((yaesta == 0) && (EstadoIA->puntosMesa >= 8)){
       yaesta = puedoMontar(EstadoIA,Carta,&CartaAux,'5');
     }
     /*Si hay 10 o más puntos en mesa, buscamos matar con triunfo pequeño si es IA dificil*/
     if ((EstadoIA->dificil == 1) && (yaesta == 0) && (EstadoIA->puntosMesa >= 10) && (EstadoIA->PaloT.N > 1) && (EstadoIA->PaloT.Datos->medianas >= 1)){
       if ((EstadoIA->PaloT.Palo[0].valor != '4') || (EstadoIA->Triunfo->valor < '6')){
         *Carta = EstadoIA->PaloT.Palo[0]; yaesta = 1;
       }
     }
     /*Si hay 6 o más puntos en mesa, buscamos matar con triunfo pequeño si es IA facil*/
     if ((EstadoIA->dificil == 0) && (yaesta == 0) && (EstadoIA->puntosMesa >= 6) && (EstadoIA->PaloT.N > 1) && (EstadoIA->PaloT.Datos->medianas >= 1)){
       if ((EstadoIA->PaloT.Palo[0].valor != '4') || (EstadoIA->Triunfo->valor < '6')){
         *Carta = EstadoIA->PaloT.Palo[0]; yaesta = 1;
       }
     }
     /*Llegados aquí, nos descartamos*/
     if (yaesta == 0){
       Descarte(EstadoIA,Carta); yaesta = 1;
     }
   }
